            ...
            if (!this._initialized) {
                ...
                if (!styled) {
                    ...
                    styles = [
                        ...
                        '.jstree-grid-header-cell {overflow: hidden; white-space: nowrap;padding: 1px 3px 2px 10px; cursor: default;font-weight: 700; font-size:1.2em;}',
                        '.jstree-grid-header-themeroller {border: 0; padding: 1px 3px;}',
                        '.jstree-grid-header-regular {position:relative; z-index: 1; height:34px;}',
        ...
        this.bind = function () {
            ...
            this.element
                ...
                .on("ready.jstree", $.proxy(function (e, data) {
                    ...
                    // console.log(this.element.find("[class~='jstree-anchor']:first").outerHeight());
                    var anchorHeight = this.element.find("[class~='jstree-anchor']:first").outerHeight() + 6, q,
                        cls = this.element.attr("class") || "";
                    $('<style type="text/css">div.jstree-grid-cell-root-' + this.rootid + ' {height: ' + anchorHeight + 'px;}</style>').appendTo("head");
