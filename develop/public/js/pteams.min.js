                ...
                var div = '' +
                        '<div class="col-12 col-sm-6 col-lg-4" style="padding: 25px;">' +
                            '<div class="service-box" style="box-shadow:-0.5px 2px 10px 1px rgba(56, 142, 144, 0.17);">' +
                                ...
                                '<button class="btn-pete col-12 detail" data-id="' + news['id'] + '" style="text-align:right!important;">View Details <i class="fas fa-long-arrow-alt-right"></i></button>' +
                                '</div>\n' +
                            '</div>' +
                        '</div>';
                $('#events').append(div);
