$(document).ready(function(){
    ...
    var uploadImage = function(id){
        ...
        ajax('GET', '/api/' + tid + '/' + id, {}, function (a) {
            if(a.success){
                $('#edit_type').val(a.data.type).selectpicker('refresh');
    ...
    var table = $('#' + tid + 'Table').DataTable({
        ...
        "drawCallback": function (settings) {
            $( ".date-convert" ).each(function( index ) {
              ...
              $( ".type-convert" ).each(function( index ) {
                $_this = $(this);
                $_tmp = parseInt($_this.text());
                switch ($_tmp)
                {
                    case(1):
                        $_this.text("Facebook") ;
    ...
    $(document).on('click', '#addBtn', function () {
        $('#edit_type').val(1).selectpicker('refresh');
        $('#edit_content').val("");
        $('#edit_link').val("");
        $('#edit_ord').val("");
