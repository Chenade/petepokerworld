<div class="card">
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs">
            <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#camSet_system_time">{{trans('bovicam.time')}}</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#camSet_system_disk">{{trans('bovicam.storage')}}</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#camSet_system_encrypt">{{trans('bovicam.videoEncrypt')}}</a>
            </li>
        </ul>
    </div>
    <div class="card-body">
        <div class="tab-content">
            <div class="tab-pane active" id="camSet_system_time">
                <div class="form-group">
                    <label class="col-form-label">{{trans('bovicam.System_Time')}}:</label>
                    <div id="camSet_system_time_serverDate" class="device-status-field">
                        <i class="fas fa-circle-notch fa-spin"></i></div>
                </div>
                <div class="form-group">
                    <label class="col-form-label">{{trans('bovicam.syncMode')}}:</label>
                    <select id="camSet_system_time_time_from" class="selectpicker show-tick form-control">
                        <option>NTP</option>
                ...
                <div class="form-group">
                    ...
                    <select id="camSet_system_time_time_zone" class="selectpicker show-tick form-control" data-size="5" data-live-search="true">
                ...
                <div id="camSet_system_time_ntp">
                    <div class="form-group">
                        <label class="col-form-label">{{trans('bovicam.syncFreq')}}:</label>
                        <select id="camSet_system_time_interval" class="selectpicker show-tick form-control">
                            <option data-subtext="minute" value="600">10</option>
                            <option data-subtext="minute" value="1800">30</option>
                            <option data-subtext="minute" value="3600">60</option>
                            <option data-subtext="minute" value="5400">90</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">{{trans('bovicam.syncbovilive')}}:</label>
                        <label class="custom-control overflow-checkbox">
                            <input type="checkbox" class="overflow-control-input" id="camSet_system_time_bovilive">
                            <span class="overflow-control-indicator"></span>
                        </label>
                    </div>
                    <div class="form-group">
                        <label class="col-form-label">{{trans('bovicam.ntpServer')}}:</label>
                        <input type="text" class="form-control" id="camSet_system_time_ntp_host" placeholder="pool.ntp.org">
                    </div>
                </div>
                <div id="camSet_system_time_manual">
                    <div class="form-group">
                        <label class="col-form-label">{{trans('bovicam.syncPc')}}:</label>
                        <label class="custom-control overflow-checkbox">
                            <input type="checkbox" class="overflow-control-input" id="camSet_system_time_sync">
                            <span class="overflow-control-indicator"></span>
                        </label>
                    </div>
                    <div id="camSet_system_time_set_time_group">
                        <div class="form-group">
                            <label class="col-form-label">{{trans('bovicam.date')}}:</label>
                            <input type="text" id="camSet_system_time_ymdhms" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <button type="submit" class="btn btn-primary" id="camSet_system_time_apply" data-loading-text="<span class='spinner-grow spinner-grow-sm'></span>">
                        {{trans('dictionary.Apply')}}
                    </button>
                </div>
            </div>
            <div class="tab-pane" id="camSet_system_disk">
                <div class="form-group">
                    <label class="col-form-label">{{trans('bovicam.selectDisk')}}:</label>
                    <select id="camSet_system_record_disk" class="selectpicker show-tick form-control">
                        <option value="sdcard">SD Card</option>
                        <option value="usbdisk">USB Disk</option>
                    </select>
                </div>
                <div class="form-group">
                    <label class="col-form-label">{{trans('bovicam.spaceKeep')}}:</label>
                    <div class="input-group">
                        <input type="number" class="form-control" id="camSet_system_record_space">
                        <div class="input-group-append">
                            <span class="input-group-text">MB</span>
                        </div>
                    </div>
                    <label class="col-form-label">{{trans('bovicam.0_disabled')}}</label>
                </div>
                <div class="form-group">
                    <label class="col-form-label">{{trans('bovicam.retention')}}:</label>
                    <div class="input-group">
                        <input type="number" class="form-control" id="camSet_system_record_time">
                        <div class="input-group-append">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary" id="camSet_system_record_apply" data-loading-text="<span class='spinner-grow spinner-grow-sm'></span>">
                        {{trans('dictionary.Apply')}}
                    </button>
                </div>
            </div>
            <div class="tab-pane" id="camSet_system_encrypt">
                <div class="form-group">
                    <label class="col-form-label">{{trans('bovicam.enabled')}}:</label>
                    <label class="custom-control overflow-checkbox">
                        <input type="checkbox" class="overflow-control-input" id="camSet_system_encrypt_enabled">
                        <span class="overflow-control-indicator"></span>
                    </label>
                </div>
                <div class="form-group">
                    <label class="col-form-label">{{trans('bovicam.key')}}:</label>
                    <div class="input-group">
                        <input type="password" class="form-control" id="camSet_system_encrypt_key" autocomplete="new-password" aria-autocomplete="none" placeholder="(unchanged)">
                        <div class="input-group-append">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary" id="camSet_system_encrypt_apply" data-loading-text="<span class='spinner-grow spinner-grow-sm'></span>">
                        {{trans('dictionary.Apply')}}
                    </button>
                </div>
            </div>
