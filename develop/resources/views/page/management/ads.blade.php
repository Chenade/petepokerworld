...
@extends('layouts.manage', ['page_header' =>'首頁廣告輪播'])
@section('content')

    <section id="manage_ads">
    ...
    <div class="modal fade" id="ads_modal" role="dialog">
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><span id="md-method">新增</span>首頁廣告輪播</h4>
