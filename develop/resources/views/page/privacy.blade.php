...
@section('content')
    ...
    <blockquote>
        <p>非常歡迎您光臨「Peter Poker World」（以下簡稱本網站），為了讓您能夠安心使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容： </p>
        ...
        <p>對於本站之隱私權政策有任何疑問，或者想提出變更、移除個人資料之請求，請 Email 至 <a href="mailto:petepokerworld@gmail.com" target="_blank">petepokerworld@gmail.com</a>。 </p>
