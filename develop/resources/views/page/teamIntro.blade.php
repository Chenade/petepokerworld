        ...
        <div class="" style="padding: 15px;" id="events">
            ...
            <div class="d-flex justify-content-center">
                <div class="col-7">
                    ...
                    <h5>【第五波】週三幸運賽</h5>
                        <p style="padding-left: 5em;">每週三中午十二點，都會固定舉辦免費回饋賽，總獎池 T$100，所有戰隊成員都可以免費報名進去抽獎！</p>
                    
                    <h5>【第六波】週五超級幸運賽</h5>
                        <p style="padding-left: 5em;">每週五中午十二點，都會固定舉辦免費加碼回饋賽，總獎池更高達 T$300，只要是小P戰隊成員並且前一週（星期四 00:00－星期三 23:59）有報名錦標賽至少 $1 以上的玩家都會換算成一定比例的籌碼進入翻牌賽，報名費越多，換算的籌碼越多，越高機會中大獎！</p>
                </div>
                <div class="col-5">
            ...
            <div class="d-flex justify-content-center" style="background-color:#E7A60A">
                <h4> 還有各種不定其 Natural8 大賽期間的專屬加碼活動，最優惠的福利只留給小P戰隊成員！</h4>
            </div>
